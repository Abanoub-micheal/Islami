...
import 'package:islamiapp_app/Screens/home/quran/itemsSura.dart';
    ...
    return Center(
      child: Column(
        children: [
          Expanded(
            flex: 1,
              child: Image.asset('assets/images/imageQuran.png')),
          ...
          Expanded(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
               return ItemSura(name: suraName[index], index: index);
